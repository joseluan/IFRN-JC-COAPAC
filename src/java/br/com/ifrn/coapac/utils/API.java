...
public class API {
    ...
    private static HashMap meus_dados;
    ...
    public HashMap buscarDados() throws IOException,org.apache.http.client.ClientProtocolException {
    ...
    public static HashMap getMeus_dados() {
        return meus_dados;
    }

    public static void setMeus_dados(HashMap meus_dados) {
